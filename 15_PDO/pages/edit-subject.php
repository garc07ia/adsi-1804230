            ...
            <div class="col-xl-6 mb-4">
              ...
              <form action="" method="post" enctype="multipart/form-data"> 
                <?php foreach ($subject as $sb):?>
                  ...
                  <label for="names">Id Materia: </label>
                  <input type="text" class="form-control" name="names" value="<?php echo $sb['id'] ?>" required>
                </div>

                <div class="form-group">
                  <label for="names">Nombre Materia: </label>
                  <input type="text" class="form-control" name="names" value="<?php echo $sb['names'] ?>" required>
                </div>
